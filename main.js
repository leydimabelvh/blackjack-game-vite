...
const generateComputerShift = (minimumPoints) => {
    ...
    setTimeout(() => {
        ...
        // if ((minimumPoints > computerPoints) && (minimumPoints <= 21)) {
        //     alert('¡Ganó el jugador!');
        //     console.warn('¡Ganó el jugador!');
        // } else if ((minimumPoints > computerPoints) && (minimumPoints > 21)) {
        ...
        // if ((computerPoints > minimumPoints) && (computerPoints > 21)) {
        //     alert('¡Ganó el jugador!');
        //     console.warn('¡Ganó el jugador!');
        // } else if ((minimumPoints > computerPoints) && (minimumPoints > 21)) {
        //     alert('¡Ganó la computadora!');
